...
public:
	...
	static AcDbObjectId InsertDwgBlockDef(TCHAR* file_name, TCHAR* block_name, bool overwrite, AcDbDatabase* database = acdbHostApplicationServices()->workingDatabase());
};
