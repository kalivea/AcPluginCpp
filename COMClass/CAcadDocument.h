...
public:
	...
	{
		VARIANT result;
		InvokeHelper(0x11, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x48, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_Materials()
	{
		LPDISPATCH result;
		InvokeHelper(0x49, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_Plot()
	{
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x18, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		CString result;
		InvokeHelper(0x22, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	CString get_Name()
	{
	...
	{
		CString result;
		InvokeHelper(0x24, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	...
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x2b, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FixErr);
	}
	...
	void Export(LPCTSTR FileName, LPCTSTR Extension, LPDISPATCH SelectionSet)
	{
		...
		InvokeHelper(0x2d, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FileName, Extension, SelectionSet);
	}
	...
	void SaveAs(LPCTSTR FullFileName, VARIANT& SaveAsType, VARIANT& vSecurityParams)
	{
		...
		InvokeHelper(0x30, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FullFileName, &SaveAsType, &vSecurityParams);
	}
	void Wblock(LPCTSTR FileName, LPDISPATCH SelectionSet)
	{
		static BYTE parms[] = VTS_BSTR VTS_DISPATCH;
		InvokeHelper(0x31, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FileName, SelectionSet);
	}
	void PurgeAll()
	{
	...
	{
		static BYTE parms[] = VTS_BSTR VTS_VARIANT;
		InvokeHelper(0x34, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Name, &Value);
	}
	void LoadShapeFile(LPCTSTR FullName)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x35, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FullName);
	}
	void Regen(long WhichViewports)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x36, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, WhichViewports);
	}
	...
	void Close(VARIANT& SaveChanges, VARIANT& FileName)
	{
		...
		InvokeHelper(0x3a, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, &SaveChanges, &FileName);
	}
	...
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x3f, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Command);
	}
	__int64 get_HWND()
	{
		__int64 result;
		InvokeHelper(0x40, DISPATCH_PROPERTYGET, VT_I8, (void*)&result, nullptr);
		return result;
	}
	CString get_WindowTitle()
	{
		CString result;
		InvokeHelper(0x41, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	...
	void StartUndoMark()
	{
		InvokeHelper(0x44, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void EndUndoMark()
	{
		InvokeHelper(0x45, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	LPDISPATCH get_ActiveMaterial()
	{
		LPDISPATCH result;
		InvokeHelper(0x4a, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x4b, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Command);
	}
